...
import StudentViewDocs from './pages/StudentViewDocs'; // <-- integrated
...
function useGuestMode() {
  ...
  const setGuestModeStatus = (isGuest) => {
    if (isGuest) localStorage.setItem('guestMode', 'true');
...
// Wrappers for guest-accessible pages
    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route path="/view-docs" element={<StudentViewDocs />} />
